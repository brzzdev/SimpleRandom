...
/// with nothing: the draw tests that need it live in another test target and carry their
/// own ten lines rather than a support library being invented to hold these (ADR-0019).
///
